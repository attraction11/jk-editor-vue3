...
import { defaultTooltipOptions } from './types'
...
export default defineComponent({
  ...
  props: {
    ...
    sticky: Boolean, // Always showingz
...
<style lang="scss">
$tooltip-color: var(--vue-custom-tooltip-color, #000); // default color
$tooltip-background: var(--vue-custom-tooltip-background, #fff); // default background color
$tooltip-radius: var(--vue-custom-tooltip-border-radius, 4px); // default border radius
$weight-normal: var(--vue-custom-tooltip-font-weight, 400); // default font weight
$has-arrow: var(--vue-custom-tooltip-has-arrow, none); // default font weight
$speed: 86ms;
$easing: ease-out;
...
.vue-custom-tooltip {
  ...
  &:after {
    ...
    text-transform: none;
    box-shadow: 0px 1px 2px 1px rgba(0, 1, 0, 0.1);
    z-index: 888;
    white-space: nowrap;
  }
